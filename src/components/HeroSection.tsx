    ...
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <motion.div className="container relative z-10 pt-24 pb-16" style={{ y: textY }}>
        <div className="max-w-2xl">
          ...
          >
            La red que conecta el campo agroecológico con{" "}
            <span className="relative inline-block">
              tu mesa
              <motion.span
                className="absolute -bottom-1 left-0 h-1 bg-wheat rounded-full"
                initial={{ width: 0 }}
                animate={{ width: "100%" }}
          ...
          >
            Mapa interactivo, marketplace y trazabilidad para productores, cooperativas, comedores, restaurantes y consumidores.
          </motion.p>
      ...
      >
        <div className="w-6 h-10 rounded-full border-2 border-primary-foreground/30 flex justify-center pt-2">
          <motion.div
            className="w-1.5 h-1.5 rounded-full bg-wheat"
